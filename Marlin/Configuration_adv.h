...
// @section lcd
  ...
  #define SHORT_MANUAL_Z_MOVE 0.04 // (mm) Smallest manual Z move (< 0.1mm) //Customized DBP
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define LCD_INFO_MENU //Customized DBP
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  16       // Babysteps are very small. Increase for faster motion. //Customized DBP 
...
#define CUSTOM_USER_MENUS //Customized DBP
  ...
  #define USER_DESC_1 "Load Bed Level" //Customized DBP
  #define USER_GCODE_1 "G28\nM420 S1" //Customized DBP

  #define USER_DESC_2 "Head Repair Position" //Customized DBP
